...
* tbed -- timestamp that the blurb was last edited

SEATS
* slug -- the auction that this is a seat at
* userid -- the user claiming this seat
* uname -- username and display name for userid
* devid -- the device claiming this seat
...
* devid -- the device this bid was placed from, maybe just for forensic purposes
* bid -- the exact string the user submitted as their bid
* tbid -- the bid's timestamp; your only bid that counts is the latest ≤ tfin
